                      ...
                      {seller && seller.user ? (
                        ...
                        >
                          ...
                          {isFollowing ? (
                            <a
                              href="#"
                              className="btn text-primary bg-translate"
                              onClick={() => {
                                const sellerName =
                                  seller.user.fname.toLowerCase() +
                                  seller.user.lname.toLowerCase();
                                UnFollowSeller(sellerName).then(() =>
                            ...
                            <a
                              href="#"
                              className="btn bg-translate text-primary"
                              onClick={() => {
                                const sellerName =
                                  seller.user.fname.toLowerCase() +
                                  seller.user.lname.toLowerCase();
                                FollowSeller(sellerName).then(() =>
                                  setIsFollowing(true)
                                );
                              }}
                            >
