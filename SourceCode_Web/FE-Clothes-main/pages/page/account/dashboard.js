...
const Dashboard = () => {
      ...
      <tr>
        ...
        <td>
          <i
            ...
            className="fa fa-search-plus mr-1"
            aria-hidden="true"
          ></i>
          {ord.orderStatus != "Shipped" ? (
            <i
              ...
              aria-hidden="true"
              onClick={() => deleteOrderEventHandler(ord.id)}
            ></i>
          ) : (
            <i></i>
          )}
  ...
  const FollowingSellers = ({ ord }) => {
    return (
      <tr>
        <th scope="row">
          {ord.user.fname} {ord.user.lname}
        </th>
        <td>
          <i
            className="fa fa-trash-o ml-1"
            aria-hidden="true"
            onClick={() => unFollowSellerEventHandler(ord.user.username)}
          ></i>
        </td>
      </tr>
    );
                              ...
                              <table className="table mb-0">
                                ...
                                <tbody>
                                  {orderData?.slice(0, 5).map((data, i) => {
                                    return <RecentOrder key={i} ord={data} />;
                                  })}
                                </tbody>
                              </table>
                            </CardBody>
                              ...
                              <table className="table table-responsive-sm mb-0">
                                ...
                                <tbody>
                                  {orderData?.map((data, i) => {
                                    return <AllOrder key={i} ord={data} />;
                                  })}
                                </tbody>
                              </table>
                            </CardBody>
                                          ...
                                          <Row>
                                            <Col sm="12">
                                              ...
                                              <Form className="theme-form">
                                                ...
                                                <Row>
                                                  <Col md="6">
                                                    <Label for="shippingAddressaddressLine">
                                                      Address Line
                                                    </Label>
                                                    <Input
                                                      type="text"
                                                      className="form-control"
                                                      id="shippingAddressaddressLine"
                                                      value={
                                                  ...
                                                  <Col md="6">
                                                    <Label for="shippingAddressstate">
                                                      Region/State *
                                                    </Label>
                                                    <Input
                                                      type="text"
