...
const Register = () => {
    ...
    function handleClick() {
        let datas1 = {username: username, firstName: firstname , lastName: lastname , email: email  , password: password , role : rSelected.toLowerCase()  };
                                ...
                                <Form className="theme-form">
                                    <Row>
                                        ...
                                        <Col md="6">
                                            ...
                                            <Input onChange={(e) => setLastname(e.target.value)} type="text" className="form-control" id="lname" placeholder="Last Name"
                                                required="" />
                                        </Col>
                                    </Row>
                                    <Row>
                                        ...
                                        <Col md="6">
                                            <h5>Choose Role</h5>
                                            <ButtonGroup>
                                                <Button  onClick={() => setRSelected("Buyer")} active={rSelected === 1}>Buyer</Button>
                                                <Button className="" onClick={() => setRSelected("Seller")} active={rSelected === 2}>Seller</Button>
                                            </ButtonGroup>
                                            <p>Role : {rSelected}</p>
                                        </Col>
                                        <Col md="6">
                                        ...
                                        <a href="/page/account/login" className="btn btn-solid" onClick={handleClick}>create Account</a>
                                    </Row>
                                </Form>
                            </div>
                        </Col>
